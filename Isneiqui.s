...
werl:
    ...
    li $a1,180    # coluna
    li $a2,4    #linha
    la $a0,nomedocara   #Endereco da STR
    li $a3,0x8870   # cores de frente(00) e fundo(FF) do texto
    li $v0,104  # print string      
    syscall

    li $a1,4    # coluna
    li $a2,4    #linha
    la $a0,STR2   #Endereco da STR
    li $a3,0x8870   # cores de frente(00) e fundo(FF) do texto
    li $v0,104  # print string      
    syscall
...
loop:
    ...
    li $a3,0x00ff   # cores de frente(00) e fundo(FF) do texto
    li $v0,104  # print string      
    syscall
    addi $t0,$t0,1
    addi $t3,$t3,1
